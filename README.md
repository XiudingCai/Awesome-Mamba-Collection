...
- (CVPR 2025) MV-SSM: Multi-View State Space Modeling for 3D Human Pose Estimation [[paper](https://arxiv.org/abs/2509.00649)] [[code](https://github.com/aviralchharia/MV-SSM)] (2025.08.31)
...
* (Neurocomputing 2025) TiM4Rec: An Efficient Sequential Recommendation Model Based on Time-Aware Structured State Space Duality Model [[paper](https://doi.org/10.1016/j.neucom.2025.131270)] [[preprint](https://arxiv.org/abs/2409.16182)] [[code](https://github.com/AlwaysFHao/TiM4Rec)] (2024.09.24)
